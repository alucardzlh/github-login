...
export function generateAESPassword(keyLength = 32) {
	// `keyLength` 是密钥的长度，常用的长度为 16 (128位), 24 (192位), 或 32 (256位)
	return webcrypto.randomBytes(keyLength).toString('base64');
}
